"""DP0 — job EXPORT của team data: ``ops.*`` (Postgres) -> MinIO ``source``.
...
def write_tx_partition(fs: pafs.S3FileSystem, bucket: str, date_str: str,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = argparse.ArgumentParser(description="DP0 export ops.* -> MinIO source")
