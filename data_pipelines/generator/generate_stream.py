"""Luồng LIVE: bắn transactions vào Redpanda theo thời gian thực.
...
def run(cfg: dict, args: argparse.Namespace) -> int:
    ...
    bootstrap = args.bootstrap or kcfg.get("bootstrap", "localhost:9092")
...
def build_parser() -> argparse.ArgumentParser:
    """CLI cho producer."""
    p = argparse.ArgumentParser(description="Bắn transactions live vào Redpanda.")
